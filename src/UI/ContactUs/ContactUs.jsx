  ...
  return (
    <div
      className={
        ...
        (showContactUs ? "animate__slideInRight" : "animate__slideOutRight")
      }
      style={{
        position: "fixed",
        right: 0,
    ...
    >
      ...
      <div className="container-fluid text-left">
        <div className="row content-section justify-content-end">
          ...
          <button
            className="btn button-primary col-sm-3 mx-3"
            aria-current="page"
          >
            {" "}
            Send{" "}
