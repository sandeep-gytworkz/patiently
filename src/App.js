  ...
  return (
    <AppContext.Provider value={{ appState: state, appDispatch: dispatch }}>
      <Routes>
        ...
        <Route exact path="/participant-profile" element={<ParticipantProfile />} />
        <Route exact path="/participants" element={<Participants />} />
        <Route exact path="/account-management" element={<AccountManagement />} />
        <Route exact path="/view-profile" element={<UserProfile />} />
        <Route exact path="/verify-otp" element={ <VerifyOtp isForgotPassword={true} changeSlide={() => {navigate("/reset-password")}} />} />
        <Route exact path="/reset-password" element={<ResetPassword />} />
        <Route exact path="/forgot-password-otp" element={<ForgotPasswordOtp />} />
      </Routes>
    </AppContext.Provider>
  );
}
